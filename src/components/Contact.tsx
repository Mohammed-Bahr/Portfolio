      ...
      <div className="container-x">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            >
              Got a project, a role, or just a wild idea? Drop a message — I usually
                  ...
                  {c.href ? (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="font-medium" style={{ color: 'var(--text)' }}>{c.value}</div>
                      </div>
                    </a>
                  ) : (
          ...
          >
            <AnimatePresence>
              {sent && (
                <motion.div
                  ...
                  style={{ background: 'var(--surface-strong)', backdropFilter: 'blur(8px)' }}
                >
                  <motion.div
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              >
                {sending ? (
                  <>
                    <span className="spinner h-4 w-4" style={{ borderWidth: 2 }} />
                    Sending…
                  </>
                ) : (
                  <>
